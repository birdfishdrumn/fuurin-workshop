...
var Router = function () {
    return (react_1["default"].createElement(react_router_1.Switch, null,
        ...
        react_1["default"].createElement(Auth_1["default"], null,
            ...
            react_1["default"].createElement(react_router_1.Route, { exact: true, path: "/user/account/delete", component: index_1.UserAccountDelete }),
            react_1["default"].createElement(react_router_1.Route, { exact: true, path: "/user/account/password", component: index_1.PasswordChange }),
