...
const WindBellCropper:React.FC<PROPS> = memo(({imageUrl,setImageUrl,pathItem,setPathItem }) => {
      ...
      <DialogTitle  id="customized-dialog-title" onClose={handleClose}>
        ...
        <div className={classes.cutButton}>
            ...
            <IconButton  onClick={getCropData} style={{cursor:"pointer"}} >
              <img alt="切り抜く" src="https://firebasestorage.googleapis.com/v0/b/fuurin-paint-workshop.appspot.com/o/sozai%2F%E3%81%AF%E3%81%95%E3%81%BF%E3%81%AE%E3%82%A2%E3%82%A4%E3%82%B3%E3%83%B3%E7%B4%A0%E6%9D%90%209%20(1).svg?alt=media&token=eb6c19e6-e6c8-476e-873f-129276aae954" style={{width:"50px",margin:"0 0 20px 0"}} />
          </IconButton>
          ...
          <DialogContent className={classes.content}>
            ...
            <div className="center">
              ...
              <BoldText>切り抜く形</BoldText>
                ...
                <Flex shape>
                  {pathData.map((p) => (
                    <ImagePallet key={p.path} onClick={() => setPathItem({
                      path: p.path,
                      viewBox:p.viewBox
                    })}>
                      <Image svg src={p.img} />
