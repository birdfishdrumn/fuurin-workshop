...
const WindBellMaker: React.FC<Partial<WINDBELLMAKERTYPE>> = ({ textLength, strip, setStrip, pathItem, setPathItem, windBellImage, setWindBellImage, wishText, inputWishText, setBackground }) => {
