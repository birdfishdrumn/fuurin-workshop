    ...
    <div>
      <Title>江戸風鈴について</Title>
       <HelpNav>
          ...
          <Title min left black><QuestionIcon/>どうやって体験する風鈴は購入しますか？</Title>
        <Text left>①まずドロワーの体験キットの購入の蘭から下部のボタンをクリックしていただきECサイトに移動していただきます。<br />
          ②ECサイトにある「体験キット」をカートに入れていただき決済してただきます。決済にはクレジットカード、銀行振り込み、コンビニ決済などが利用できます。</Text>
