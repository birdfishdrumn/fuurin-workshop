    ...
    return (react_1["default"].createElement("div", null,
        react_1["default"].createElement(GlobalLayoutStyle_1.SectionContainer, null,
            react_1["default"].createElement(GlobalLayoutStyle_1.IconFlex, null,
                react_1["default"].createElement(NavIcon, { onClick: function () { return dispatch(connected_react_router_1.push("/search")); } },
                    react_1["default"].createElement(Search_1["default"], { style: { fontSize: "45px" } }),
                    react_1["default"].createElement("br", null),
                    react_1["default"].createElement(GlobalLayoutStyle_1.BoldText, null, "\u691C\u7D22")),
                react_1["default"].createElement(NavIcon, { onClick: function () { return dispatch(connected_react_router_1.push("/population")); } },
                    react_1["default"].createElement(Favorite_1["default"], { style: { fontSize: "45px" } }),
                    react_1["default"].createElement(GlobalLayoutStyle_1.BoldText, null, "\u4EBA\u6C17"))))));
};
