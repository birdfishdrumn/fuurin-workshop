      ...
      <SectionWrapping large>
        <BackgroundWhite>
          ...
          <HelpNav>
                ...
                <Title pointer left><LiveHelpIcon style={{ fontSize: "30px",margin:"0 10px -7px 0" }}/>当サービスについて</Title>
              ...
              <li  onClick={()=>locationChange(3)}>
                <Title pointer left><AccountBoxIcon style={{ fontSize: "30px",margin:"0 10px -7px 0" }}/>アカウント</Title>
                <Text left>プロフィールの編集方法、アカウントの設定などについて紹介致します。</Text>
              </li>
              <li  onClick={()=>locationChange(4)}>
                <Title pointer left><FavoriteIcon style={{ fontSize: "30px",margin:"0 10px -7px 0" }}/>お気に入りシステム</Title>
                <Text left>
              ...
              <li  onClick={()=>locationChange(7)}>
                  <Title pointer left><BuildIcon style={{ fontSize: "30px", margin: "0 10px -7px 0" }} />素材</Title>
