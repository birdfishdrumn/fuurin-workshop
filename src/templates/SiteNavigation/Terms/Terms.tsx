...
import { SectionWrapping, Title, Text, BackgroundWhite, PrivacyNav } from "assets/GlobalLayoutStyle";
  ...
  return (
    <div>
      ...
      <SectionWrapping>
        <BackgroundWhite>
          <Title >利用規約</Title>
            <Text left>この利用規約（以下，「本規約」といいます。）は，ふうりん体験（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</Text>
          ...
          <PrivacyNav>ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</PrivacyNav>
    </BackgroundWhite>
  </SectionWrapping>
  </div>
  )
