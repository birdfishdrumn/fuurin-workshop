       ...
       <BackgroundWhite>
        ...
        <TwoColumn>
          <div>
            ...
            <StyledImage width={"300"} src="https://firebasestorage.googleapis.com/v0/b/instagram-react-a7035.appspot.com/o/sozai%2Ftaiken_kit_contents.jpg?alt=media&token=dd683b38-f182-4e9e-9b20-affcaa163559" />
          ...
          <SimpleGrid two>
            <div>
              ...
              <MinText left color={"dimgray"}>江戸風鈴は音が違うので、どんな音になるかはお楽しみに。<br/>また江戸風鈴の仕様上、ガラスに気泡などが入っていまのでご了承ください。短冊はまるよし風鈴のロゴが入った天地ぼかしのものが一つ入っております。</MinText>
            </div>
            <div>
              ...
              <Title min>平筆、細筆、水彩絵具７色</Title>
               <MinText left color={"dimgray"}>細筆は花火など細かい線を引く絵に、太い筆はベタ塗りやお花のグラデーションを表現することに使えます。<br/>絵の具は当店で体験用として使用しているポスターカラーになります。最初は固まっているので水で溶かして使ってください。</MinText>
                   </div>
          </SimpleGrid>
