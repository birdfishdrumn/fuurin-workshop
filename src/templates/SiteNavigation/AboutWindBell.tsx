...
import { SectionWrapping, Title, Text, BackgroundWhite, SimpleGrid, CircleImage, MinText, StyledImage } from "assets/GlobalLayoutStyle";
    ...
    <div>
      ...
      <SectionWrapping>
        <BackgroundWhite>
          ...
          <TwoColumn>
          <div>
              <Text left>江戸風鈴は江戸時代から伝わる技術を受け継いで制作しているガラス製の風鈴です。<br /><br />型を使わずに宙吹きで作られ、絵は全て職人の手によって一つ一つ彩色されています。柄も明るい夏にぴったりの金魚や花火、可愛いじんべえ鮫や招き猫など多くの種類のものがあり,一つ一つ縁起の良い意味があります。<br /><br />
                また「江戸風鈴」は商標登録されており日本中で二件しか作られていません。このサービスをきっかけに皆様が職人の作ったものを触れていただくこと願っております。
              </Text>
            </div>

            <StyledImage width={"350"} src="https://firebasestorage.googleapis.com/v0/b/fuurin-paint-workshop.appspot.com/o/sozai%2Fkingyo_re.jpg?alt=media&token=1ea25566-7e95-4ca7-a159-6b77c59b0471" />
          ...
          <SimpleGrid>
            <div>
              ...
              <Title min>宙吹き</Title>
              <MinText left color={"dimgray"}>一つ一つ型を使わず、宙で形を整えて作ります。そのため音も違います。</MinText>
            </div>
            <div>
              ...
              <MinText left color={"dimgray"}>風鈴の鳴り口にガラス管がスレただけで心地よい音が鳴ります。</MinText>
            </div>
            <div>
              ...
              <MinText left color={"dimgray"}>絵を内側から描くことで、ガラスの艶を生かした透明感のあるものに仕上がります。</MinText>
            </div>
          </SimpleGrid>
