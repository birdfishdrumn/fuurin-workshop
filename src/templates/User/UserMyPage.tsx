  ...
  return (
    <SectionContainer>
      ...
      <div className={classes.profile}>
        <AccountCircleIcon color="primary" style={{ margin: '0 10px -5px 0' }} />
        <StyledBoldText center>お名前</StyledBoldText>
        <MinText left style={{ marginTop: '10px', fontWeight: 600 }}>
          {username}
        </MinText>
      </div>
      <div className={classes.profile}>
        <MailIcon color="primary" style={{ margin: '0 10px -5px 0' }} />
        <StyledBoldText center>email</StyledBoldText>
        <MinText left style={{ marginTop: '10px', fontWeight: 600 }}>
          {email}
        </MinText>
      </div>
      <div className="center">
        <div className={classes.profile}>
          <DescriptionIcon color="primary" style={{ margin: '0 10px -5px 0' }} />{' '}
          <StyledBoldText center>プロフィール</StyledBoldText>
          <MinText style={{ marginTop: '10px', fontWeight: 600 }}>
            {profile && returnCodeToBr(profile)}
          </MinText>
        </div>
        <div className={classes.profile}>
          <LanguageIcon color="primary" style={{ margin: '0 10px -5px 0' }} />
          <StyledBoldText center>Url</StyledBoldText>
          <MinText left style={{ marginTop: '10px', fontWeight: 600 }}>
            {url}
          </MinText>
        </div>
        <div className={classes.profile}>
          <ColorTwitterIcon style={{ margin: '0 10px -5px 0' }} />
          <StyledBoldText center>twitter</StyledBoldText>
          <MinText style={{ marginTop: '10px', fontWeight: 600 }}>{twitter}</MinText>
        </div>
        <div className={classes.profile}>
          <ColorInstagramIcon style={{ margin: '0 10px -5px 0' }} />
          <StyledBoldText center>Instagram</StyledBoldText>
