    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 7, , 8]);
                // お気に入りの作品を削除する。
                return [4 /*yield*/, firebaseTools.firestore["delete"]("users/" + userId + "/likes", {
            ...
            case 2:
                ...
                _a.sent();
                // お気に入りしたuserのサブコレクションを削除する。
                return [4 /*yield*/, firebaseTools.firestore["delete"]("users/" + userId + "/likeUser", {
                        project: process.env.GCLOUD_PROJECT,
                        recursive: true,
                        yes: true,
                        token: functions.config().fb.token
...
exports.onDeletePost = functions
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, firebaseTools.firestore["delete"]("posts/" + postId + "/comments", {
                        project: process.env.GCLOUD_PROJECT,
                        recursive: true,
                        yes: true,
                        token: functions.config().fb.token
